                ...
                <div class="p-4 sm:p-7">
                    ...
                    <form wire:submit.prevent="save">
                        <div class="grid gap-y-4">
                            ...
                            <!-- Address -->
                            <div>
                                <label for="address" class="block mb-2 text-sm dark:text-white">Address</label>
                                <div class="relative">
                            ...
                            <!-- State -->
                            <div>
                                <label for="state" class="block mb-2 text-sm dark:text-white">State</label>
                                <div class="relative">
                                    <input type="text" id="state" name="state" wire:model="state"
                                        class="block w-full px-4 py-3 text-sm border border-gray-200 rounded-lg focus:border-amber-500 focus:ring-amber-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                                        required aria-describedby="state-error">
                                    @error('state')
                                    <div class="absolute inset-y-0 flex items-center pointer-events-none end-0 pe-3">
                                        <svg class="w-5 h-5 text-red-500" width="16" height="16" fill="currentColor"
                                            viewBox="0 0 16 16" aria-hidden="true">
                                ...
                                @error('state')
                                <p class="mt-2 text-xs text-red-600" id="state-error">{{ $message }}</p>
                                @enderror
                            </div>
