<div class="max-w-2xl p-6 mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
    ...
    <form wire:submit.prevent="updateProfile">
        ...
        <div class="mb-4">
            <label class="block text-gray-700 dark:text-gray-300" for="password_confirmation">Confirm Password</label>
        ...
        <button type="submit" class="px-4 py-2 text-white rounded bg-amber-600 hover:bg-amber-700">Update
            Profile</button>
    </form>
    ...
    <ul>
        ...
        <li class="flex items-center justify-between p-4 mb-4 bg-gray-100 rounded dark:bg-gray-700">
            ...
            <button wire:click="removeAddress({{ $address['id'] }})" class="text-red-500 hover:text-red-700">
                Delete
            </button>
        </li>
        @endforeach
    ...
    <form wire:submit.prevent="addAddress">
        <div class="mb-4">
            <label class="block text-gray-700 dark:text-gray-300" for="newAddress.address">Address</label>
        ...
        <div class="mb-4">
            <label class="block text-gray-700 dark:text-gray-300" for="newAddress.state">State</label>
        ...
        <button type="submit" class="px-4 py-2 text-white bg-blue-600 rounded hover:bg-blue-700">Add Address</button>
    </form>
</div>
