...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        //     ->create());
        // Brand::query()->update(['sort' => DB::raw('id')]);
        ...
        // $productsSeller1 = $this->withProgressBar(20, fn() => Product::factory()->count(20)
        //     ->sequence(fn($sequence) => ['shop_brand_id' => $brands->random(1)->first()->id])
        //     ->attach($categories->random(rand(3, 6)), ['created_at' => now(), 'updated_at' => now()])
        //     ->has(
        //         Comment::factory()->count(rand(10, 20))
        //             ->state(fn(array $attributes, Product $product) => ['user_id' => $buyerUser->id]),
        //     )
        //     ->create());
        ...
        // $productsSeller2 = $this->withProgressBar(30, fn() => Product::factory()->count(30)
        //     ->sequence(fn($sequence) => ['shop_brand_id' => $brands->random(1)->first()->id])
        //     ->attach($categories->random(rand(3, 6)), ['created_at' => now(), 'updated_at' => now()])
        //     ->has(
        //         Comment::factory()->count(rand(10, 20))
        ...
        // $orders = $this->withProgressBar(50, fn() => Order::factory()->count(50)
        //     ->sequence(fn($sequence) => ['user_id' => $buyerUser->id])
        ...
        // $blogCategories = $this->withProgressBar(20, fn() => BlogCategory::factory()->count(20)->create());
        ...
        //                     ->state(fn(array $attributes, Post $post) => ['user_id' => $buyerUser->id]),
        //             )
